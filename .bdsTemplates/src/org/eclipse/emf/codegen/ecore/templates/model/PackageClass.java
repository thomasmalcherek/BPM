...
public class PackageClass
{
  ...
  protected final String TEXT_23 = NL + "  /**" + NL + "\t* Static Member variable that points to the BDS Validation Class" + NL + "\t* <!-- begin-user-doc -->" + NL + "    * <!-- end-user-doc -->" + NL + "\t* @generated" + NL + "\t*/";
  protected final String TEXT_24 = NL + "  ";
  protected final String TEXT_25 = " bdsValidationUtils = ";
  protected final String TEXT_26 = ".init();" + NL + "" + NL + "  /** " + NL + "    * Exposes bundle version number, or null if not instantiated via OSGi" + NL + "    * @generated" + NL + "    */" + NL + "  public String getBundleVersion();";
  protected final String TEXT_27 = NL + NL + "  /** " + NL + "    * Exposes bundle version number, or null if not instantiated via OSGi" + NL + "    * @generated" + NL + "    */" + NL + "  public String getBundleVersion()" + NL + "  {" + NL + "    String result = ";
  protected final String TEXT_28 = ".getBundleVersion();" + NL + "    return result;" + NL + "  }";
 ...
 */
    ...
    // ** TIBCO: Additional include to allow additions to the EPackage ** 
    // ** Add the BDS Validation static member variable to the interface ** 
    if (isInterface) {
    stringBuffer.append(TEXT_23);
    stringBuffer.append(TEXT_24);
    stringBuffer.append(genModel.getImportedName(genModel.getFeatureMapWrapperInterface().replaceFirst("BDSFeatureMap$","BDSValidationUtils")));
    stringBuffer.append(TEXT_25);
    stringBuffer.append(genModel.getImportedName(genModel.getFeatureMapWrapperInterface().replaceFirst("BDSFeatureMap$","BDSValidationUtils")));
    stringBuffer.append(TEXT_26);
    } else {
    stringBuffer.append(TEXT_27);
    stringBuffer.append(genModel.getImportedName(genModel.getFeatureMapWrapperInterface().replaceFirst("BDSFeatureMap$","BDSActivator")));
