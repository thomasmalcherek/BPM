...
public class FactoryClass
{
  ...
  protected final String TEXT_190 = NL + "\t\t// If the argument passed in is null, return null" + NL + "\t\tif( initialValue == null )" + NL + "\t\t{" + NL + "\t\t\treturn null;" + NL + "\t\t}";
  ...
  protected final String TEXT_248 = ".INSTANCE.validate(eDataType, result, null, null))" + NL + "\t\t\t{" + NL + "\t\t\t\treturn result;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tcatch (RuntimeException e)" + NL + "\t\t{" + NL + "\t\t\texception = e;" + NL + "\t\t}";
  protected final String TEXT_249 = NL + "\t\tif (result != null || exception == null) return result;" + NL + "    " + NL + "\t\tthrow exception;";
  protected final String TEXT_250 = NL + "\t\treturn ";
  protected final String TEXT_251 = "(";
  protected final String TEXT_252 = ")";
  protected final String TEXT_253 = "super.createFromString(initialValue);";
  protected final String TEXT_254 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new ";
  ...
  protected final String TEXT_261 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic String convert";
  ...
  protected final String TEXT_369 = ")instanceValue).toPlainString();";
  protected final String TEXT_370 = NL + "\t\treturn ";
  protected final String TEXT_371 = ".convertToString(";
  protected final String TEXT_372 = ", instanceValue);";
  protected final String TEXT_373 = NL + "\t\treturn convert";
  protected final String TEXT_374 = "((";
  protected final String TEXT_375 = ")instanceValue);";
  protected final String TEXT_376 = NL + "\t\tif (instanceValue == null) return null;" + NL + "\t\t";
  protected final String TEXT_377 = " list = (";
  protected final String TEXT_378 = ")instanceValue;" + NL + "\t\tif (list.isEmpty()) return \"\";" + NL + "\t\t";
  protected final String TEXT_379 = " result = new ";
  protected final String TEXT_380 = "();";
  protected final String TEXT_381 = NL + "\t\tfor (";
  protected final String TEXT_382 = " i = list.iterator(); i.hasNext(); )";
  protected final String TEXT_383 = NL + "\t\tfor (";
  protected final String TEXT_384 = " item : list)";
  protected final String TEXT_385 = NL + "\t\t{";
  protected final String TEXT_386 = NL + "\t\t\tresult.append(convert";
  ...
  protected final String TEXT_394 = NL + "\t\t\tresult.append(' ');" + NL + "\t\t}" + NL + "\t\treturn result.substring(0, result.length() - 1);";
  protected final String TEXT_395 = NL + "\t\treturn instanceValue == null ? null : convert";
  protected final String TEXT_396 = "(((";
  protected final String TEXT_397 = ")instanceValue)";
  protected final String TEXT_398 = ".";
  protected final String TEXT_399 = "()";
  protected final String TEXT_400 = ");";
  protected final String TEXT_401 = NL + "\t\treturn convert";
  protected final String TEXT_402 = "(instanceValue);";
  protected final String TEXT_403 = NL + "\t\tif (instanceValue == null) return null;";
  protected final String TEXT_404 = NL + "\t\tif (";
  protected final String TEXT_405 = ".isInstance(instanceValue))" + NL + "\t\t{" + NL + "\t\t\ttry" + NL + "\t\t\t{";
  protected final String TEXT_406 = NL + "\t\t\t\tString value = convert";
  protected final String TEXT_407 = "ToString(";
  protected final String TEXT_408 = ", instanceValue);";
  protected final String TEXT_409 = NL + "\t\t\t\tString value = ";
  protected final String TEXT_410 = ".convertToString(";
  protected final String TEXT_411 = ", instanceValue);";
  protected final String TEXT_412 = NL + "\t\t\t\tif (value != null) return value;" + NL + "\t\t\t}" + NL + "\t\t\tcatch (Exception e)" + NL + "\t\t\t{" + NL + "\t\t\t\t// Keep trying other member types until all have failed." + NL + "\t\t\t}" + NL + "\t\t}";
  protected final String TEXT_413 = NL + "\t\tthrow new IllegalArgumentException(\"Invalid value: '\"+instanceValue+\"' for datatype :\"+eDataType.getName());";
  protected final String TEXT_414 = NL + "\t\treturn super.convertToString(instanceValue);";
  protected final String TEXT_415 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new ";
  protected final String TEXT_416 = "();";
  protected final String TEXT_417 = NL + "\t\treturn super.convertToString(eDataType, instanceValue);";
  protected final String TEXT_418 = NL + "\t}" + NL;
  protected final String TEXT_419 = NL + "\t/**" + NL + "\t * Returns a new object of class '<em>";
  protected final String TEXT_420 = "</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return a new object of class '<em>";
  protected final String TEXT_421 = "</em>'." + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_422 = " create";
  protected final String TEXT_423 = "();" + NL;
  protected final String TEXT_424 = NL + "\t/**" + NL + "\t * Returns an instance of data type '<em>";
  protected final String TEXT_425 = "</em>' corresponding the given literal." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param literal a literal of the data type." + NL + "\t * @return a new instance value of the data type." + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_426 = " create";
  protected final String TEXT_427 = "(String literal);" + NL + "" + NL + "\t/**" + NL + "\t * Returns a literal representation of an instance of data type '<em>";
  protected final String TEXT_428 = "</em>'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param instanceValue an instance value of the data type." + NL + "\t * @return a literal representation of the instance value." + NL + "\t * @generated" + NL + "\t */" + NL + "\tString convert";
  protected final String TEXT_429 = "(";
  protected final String TEXT_430 = " instanceValue);" + NL;
  protected final String TEXT_431 = NL + "\t/**" + NL + "\t * Returns the package supported by this factory." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the package supported by this factory." + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_432 = " get";
  protected final String TEXT_433 = "();" + NL;
  protected final String TEXT_434 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_435 = " get";
  protected final String TEXT_436 = "()" + NL + "\t{" + NL + "\t\treturn (";
  protected final String TEXT_437 = ")getEPackage();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @deprecated" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_438 = NL + "\t@Deprecated";
  protected final String TEXT_439 = NL + "\tpublic static ";
  protected final String TEXT_440 = " getPackage()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_441 = ".eINSTANCE;" + NL + "\t}" + NL;
 ...
 */
    ...
    // ** START TIBCO CUSTOM CHANGE ** 
    stringBuffer.append(TEXT_190);
    // ** END TIBCO CUSTOM CHANGE ** 
    ...
    // ** START TIBCO CUSTOM CHANGE ** 
    if (genDataType.getEcoreDataType().getInstanceTypeName().equals("java.math.BigDecimal")) {
