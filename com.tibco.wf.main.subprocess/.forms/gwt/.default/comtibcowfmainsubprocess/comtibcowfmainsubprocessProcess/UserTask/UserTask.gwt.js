...
fc['validation_SubProxy_SubProxy__length'] = function(formId, controlName, cloneUID, listIndex) {
	var valScr = 'typeof context.stringValue != \'undefined\' && typeof tibco.forms.Util != \'undefined\' ? tibco.forms.Util.checkTextLength(context.stringValue, 5000) ? true : [context.control.getLabel(), \'5000\'] : context.value.length <= 5000;';
	...
	fc['DataModel']=function(formId) {
		...
		this.getSubProxy = function(useInternal) {
			return this.form.dataMap['SubProxy'].getValue(useInternal);
		};
		this.setSubProxy = function(value) {
			return this.form.dataMap['SubProxy'].setValue(value);
		};
	}
