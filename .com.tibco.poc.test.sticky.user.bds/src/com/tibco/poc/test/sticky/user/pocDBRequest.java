 ...
 * <ul>
 *   <li>{@link com.tibco.poc.test.sticky.user.pocDBRequest#getWFCaseID <em>WF Case ID</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.tibco.poc.test.sticky.user.UserPackage#getpocDBRequest()
...
public interface pocDBRequest extends EObject
{
   ...
   * @see com.tibco.poc.test.sticky.user.UserPackage#getpocDBRequest_WFCaseID()
   * @model dataType="com.tibco.poc.test.sticky.user.WFCaseID_pocDBRequestType" required="true"
  ...
  /**
   * Sets the value of the '{@link com.tibco.poc.test.sticky.user.pocDBRequest#getWFCaseID <em>WF Case ID</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
