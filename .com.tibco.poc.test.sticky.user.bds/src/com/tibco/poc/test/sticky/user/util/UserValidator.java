 ...
 * @generated
 */
public class UserValidator extends EObjectValidator
{
  /**
   ...
   * @generated
   */
  public static final String DIAGNOSTIC_SOURCE = "com.tibco.poc.test.sticky.user";
  ...
  protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    switch (classifierID)
    {
      case UserPackage.DOCUMENT_ROOT:
        return validateDocumentRoot((DocumentRoot)value, diagnostics, context);
      case UserPackage.POC_DB_REQUEST:
        return validatepocDBRequest((pocDBRequest)value, diagnostics, context);
      case UserPackage.POC_META_DATA:
  ...
  public boolean validateAHVNummer_pocMetaDataType_MaxLength(String ahvNummer_pocMetaDataType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!result && diagnostics != null)
      reportMaxLengthViolation(UserPackage.Literals.AHV_NUMMER_POC_META_DATA_TYPE, ahvNummer_pocMetaDataType, length, 50, diagnostics, context);
    return result;
  }
  ...
  public boolean validatedokumentenArt_pocMetaDataType_MaxLength(String dokumentenArt_pocMetaDataType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    boolean result = length <= 50;
    if (!result && diagnostics != null)
      reportMaxLengthViolation(UserPackage.Literals.DOKUMENTEN_ART_POC_META_DATA_TYPE, dokumentenArt_pocMetaDataType, length, 50, diagnostics, context);
    return result;
  }
  ...
  public boolean validatekanton_pocMetaDataType_MaxLength(String kanton_pocMetaDataType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    boolean result = length <= 50;
    if (!result && diagnostics != null)
      reportMaxLengthViolation(UserPackage.Literals.KANTON_POC_META_DATA_TYPE, kanton_pocMetaDataType, length, 50, diagnostics, context);
    return result;
  }
  ...
  public boolean validatepartnerID_pocMetaDataType_MaxLength(String partnerID_pocMetaDataType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    boolean result = length <= 50;
    if (!result && diagnostics != null)
      reportMaxLengthViolation(UserPackage.Literals.PARTNER_ID_POC_META_DATA_TYPE, partnerID_pocMetaDataType, length, 50, diagnostics, context);
    return result;
  }
  ...
  public boolean validateWFCaseID_pocMetaDataType_MaxLength(String wfCaseID_pocMetaDataType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    boolean result = length <= 50;
    if (!result && diagnostics != null)
      reportMaxLengthViolation(UserPackage.Literals.WF_CASE_ID_POC_META_DATA_TYPE, wfCaseID_pocMetaDataType, length, 50, diagnostics, context);
    return result;
  }
  ...
  public boolean validateWFCaseID_pocDBRequestType_MaxLength(String wfCaseID_pocDBRequestType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    boolean result = length <= 50;
    if (!result && diagnostics != null)
      reportMaxLengthViolation(UserPackage.Literals.WF_CASE_ID_POC_DB_REQUEST_TYPE, wfCaseID_pocDBRequestType, length, 50, diagnostics, context);
    return result;
  }
