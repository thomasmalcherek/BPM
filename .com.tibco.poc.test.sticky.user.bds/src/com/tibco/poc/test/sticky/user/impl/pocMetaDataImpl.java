...
import com.tibco.poc.test.sticky.user.bdsutil.BDSCopyUtil;
import com.tibco.poc.test.sticky.user.bdsutil.BDSNotifyingCalendar;
 ...
 * <ul>
 *   <li>{@link com.tibco.poc.test.sticky.user.impl.pocMetaDataImpl#getWFCaseID <em>WF Case ID</em>}</li>
 *   <li>{@link com.tibco.poc.test.sticky.user.impl.pocMetaDataImpl#getAHVNummer <em>AHV Nummer</em>}</li>
 *   <li>{@link com.tibco.poc.test.sticky.user.impl.pocMetaDataImpl#getPartnerID <em>Partner ID</em>}</li>
 *   <li>{@link com.tibco.poc.test.sticky.user.impl.pocMetaDataImpl#getDokumentenArt <em>Dokumenten Art</em>}</li>
 *   <li>{@link com.tibco.poc.test.sticky.user.impl.pocMetaDataImpl#getKanton <em>Kanton</em>}</li>
 *   <li>{@link com.tibco.poc.test.sticky.user.impl.pocMetaDataImpl#getFrist <em>Frist</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class pocMetaDataImpl extends EObjectImpl implements pocMetaData
{
  ...
  {
    return UserPackage.Literals.POC_META_DATA;
  }
  ...
  public void setWFCaseID(String newWFCaseID)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UserPackage.POC_META_DATA__WF_CASE_ID, oldWFCaseID, wfCaseID));
  }
  ...
  public void setAHVNummer(String newAHVNummer)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UserPackage.POC_META_DATA__AHV_NUMMER, oldAHVNummer, ahvNummer));
  }
  ...
  public void setPartnerID(String newPartnerID)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UserPackage.POC_META_DATA__PARTNER_ID, oldPartnerID, partnerID));
  }
  ...
  public void setDokumentenArt(String newDokumentenArt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UserPackage.POC_META_DATA__DOKUMENTEN_ART, oldDokumentenArt, dokumentenArt));
  }
  ...
  public void setKanton(String newKanton)
  {
    ...
    kanton = newKanton;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UserPackage.POC_META_DATA__KANTON, oldKanton, kanton));
  }
  ...
  public void setFrist(XMLGregorianCalendar newFrist)
  {
    ...
    { 
      ...
      if (newFrist != null)
      {
        newFrist = new BDSNotifyingCalendar((XMLGregorianCalendar)BDSCopyUtil.copyIfMutable(newFrist), this, UserPackage.POC_META_DATA__FRIST);
      }
    }
    XMLGregorianCalendar oldFrist = frist;
    frist = newFrist;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UserPackage.POC_META_DATA__FRIST, oldFrist, frist));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UserPackage.POC_META_DATA__WF_CASE_ID:
        return getWFCaseID();
      case UserPackage.POC_META_DATA__AHV_NUMMER:
        return getAHVNummer();
      case UserPackage.POC_META_DATA__PARTNER_ID:
        return getPartnerID();
      case UserPackage.POC_META_DATA__DOKUMENTEN_ART:
        return getDokumentenArt();
      case UserPackage.POC_META_DATA__KANTON:
        return getKanton();
      case UserPackage.POC_META_DATA__FRIST:
        return getFrist();
    }
