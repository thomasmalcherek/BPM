 ...
 * <ul>
 *   <li>{@link com.example.comtibcopoctest.DocumentRoot#getMixed <em>Mixed</em>}</li>
 *   <li>{@link com.example.comtibcopoctest.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link com.example.comtibcopoctest.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link com.example.comtibcopoctest.DocumentRoot#getPocDBRequestElement <em>Poc DB Request Element</em>}</li>
 *   <li>{@link com.example.comtibcopoctest.DocumentRoot#getPocMetaDataElement <em>Poc Meta Data Element</em>}</li>
 *   <li>{@link com.example.comtibcopoctest.DocumentRoot#getPocDBRequestBDSInternalSerializationElement <em>Poc DB Request BDS Internal Serialization Element</em>}</li>
 *   <li>{@link com.example.comtibcopoctest.DocumentRoot#getPocMetaDataBDSInternalSerializationElement <em>Poc Meta Data BDS Internal Serialization Element</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.example.comtibcopoctest.ComtibcopoctestPackage#getDocumentRoot()
...
public interface DocumentRoot extends EObject
{
   ...
   * @see com.example.comtibcopoctest.ComtibcopoctestPackage#getDocumentRoot_Mixed()
   ...
   * @see com.example.comtibcopoctest.ComtibcopoctestPackage#getDocumentRoot_XMLNSPrefixMap()
   ...
   * @see com.example.comtibcopoctest.ComtibcopoctestPackage#getDocumentRoot_XSISchemaLocation()
   * @model mapType="org.eclipse.emf.ecore.EStringToStringMapEntry<org.eclipse.emf.ecore.EString, org.eclipse.emf.ecore.EString>" transient="true"
   ...
   * @see com.example.comtibcopoctest.ComtibcopoctestPackage#getDocumentRoot_PocDBRequestElement()
  ...
  /**
   * Sets the value of the '{@link com.example.comtibcopoctest.DocumentRoot#getPocDBRequestElement <em>Poc DB Request Element</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.example.comtibcopoctest.ComtibcopoctestPackage#getDocumentRoot_PocMetaDataElement()
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
  ...
  /**
   * Sets the value of the '{@link com.example.comtibcopoctest.DocumentRoot#getPocMetaDataElement <em>Poc Meta Data Element</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.example.comtibcopoctest.ComtibcopoctestPackage#getDocumentRoot_PocDBRequestBDSInternalSerializationElement()
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
  ...
  /**
   * Sets the value of the '{@link com.example.comtibcopoctest.DocumentRoot#getPocDBRequestBDSInternalSerializationElement <em>Poc DB Request BDS Internal Serialization Element</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.example.comtibcopoctest.ComtibcopoctestPackage#getDocumentRoot_PocMetaDataBDSInternalSerializationElement()
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
  ...
  /**
   * Sets the value of the '{@link com.example.comtibcopoctest.DocumentRoot#getPocMetaDataBDSInternalSerializationElement <em>Poc Meta Data BDS Internal Serialization Element</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
