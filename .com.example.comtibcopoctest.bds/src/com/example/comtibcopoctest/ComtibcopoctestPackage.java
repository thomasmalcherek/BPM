...
public interface ComtibcopoctestPackage extends EPackage
{
  ...
  */
  ...
  /**
   * Returns the meta object for the attribute '{@link com.example.comtibcopoctest.pocMetaData#getFrist <em>Frist</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Frist</em>'.
   * @see com.example.comtibcopoctest.pocMetaData#getFrist()
   * @see #getpocMetaData()
   * @generated
   */
