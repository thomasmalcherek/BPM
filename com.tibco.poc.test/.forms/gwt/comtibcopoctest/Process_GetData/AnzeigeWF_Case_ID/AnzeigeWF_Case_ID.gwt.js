...
tibcoforms.formCode['_0s8okPJPEeif9tfFlBJi7Q'] = new Object();
tibcoforms.formCode['_0s8okPJPEeif9tfFlBJi7Q']['defineActions'] = function() {
var fc = tibcoforms.formCode['_0s8okPJPEeif9tfFlBJi7Q'];
...
tibcoforms.formCode['_0s8okPJPEeif9tfFlBJi7Q']['defineActions']();

tibcoforms.formCode['_0s8okPJPEeif9tfFlBJi7Q']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_0s8okPJPEeif9tfFlBJi7Q'];
...
fc['validation_ParameterIn_WF_CASE_ID_ParameterIn_WF_CASE_ID__length'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getParameterIn_WF_CASE_ID = function(useInternal) {
			return this.form.dataMap['ParameterIn_WF_CASE_ID'].getValue(useInternal);
		};
		this.setParameterIn_WF_CASE_ID = function(value) {
			return this.form.dataMap['ParameterIn_WF_CASE_ID'].setValue(value);
		};
...
tibcoforms.formCode['_0s8okPJPEeif9tfFlBJi7Q']['defineValidations']();
