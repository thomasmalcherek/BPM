...
tibcoforms.formCode['_tPRD8PcOEei7Xb3kYsEHgg'] = new Object();
tibcoforms.formCode['_tPRD8PcOEei7Xb3kYsEHgg']['defineActions'] = function() {
var fc = tibcoforms.formCode['_tPRD8PcOEei7Xb3kYsEHgg'];
...
tibcoforms.formCode['_tPRD8PcOEei7Xb3kYsEHgg']['defineActions']();

tibcoforms.formCode['_tPRD8PcOEei7Xb3kYsEHgg']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_tPRD8PcOEei7Xb3kYsEHgg'];
...
fc['validation_MetaData_GetData_task_MetaData_GetData_task__length'] = function(formId, controlName, cloneUID, listIndex) {
	var valScr = 'typeof context.stringValue != \'undefined\' && typeof tibco.forms.Util != \'undefined\' ? tibco.forms.Util.checkTextLength(context.stringValue, 50) ? true : [context.control.getLabel(), \'50\'] : context.value.length <= 50;';
	// return tibco.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "MetaData_GetData_task: MetaData_GetData_task__length", true, true);
	return tibco.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "MetaData_GetData_task__length", true, true);
}
...
tibcoforms.formCode['_tPRD8PcOEei7Xb3kYsEHgg']['defineValidations']();
