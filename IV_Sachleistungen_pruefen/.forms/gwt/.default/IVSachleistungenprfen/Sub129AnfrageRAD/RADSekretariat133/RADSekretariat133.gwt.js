...
tibcoforms.formCode['_t2USABW8Eemwx6NixRoh7A'] = new Object();
tibcoforms.formCode['_t2USABW8Eemwx6NixRoh7A']['defineActions'] = function() {
var fc = tibcoforms.formCode['_t2USABW8Eemwx6NixRoh7A'];
...
tibcoforms.formCode['_t2USABW8Eemwx6NixRoh7A']['defineActions']();

tibcoforms.formCode['_t2USABW8Eemwx6NixRoh7A']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_t2USABW8Eemwx6NixRoh7A'];
...
fc['validation_Dokument_documentSecurity_Dokument_documentSecurity__upperLimit'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getSP_Weiterleiten_an_RAD_Sekretariat = function(useInternal) {
			return this.form.dataMap['SP_Weiterleiten_an_RAD_Sekretariat'].getValue(useInternal);
		};
		this.setSP_Weiterleiten_an_RAD_Sekretariat = function(value) {
			return this.form.dataMap['SP_Weiterleiten_an_RAD_Sekretariat'].setValue(value);
		};
		this.getSP_Anfrage_RAD_abschliessen = function(useInternal) {
			return this.form.dataMap['SP_Anfrage_RAD_abschliessen'].getValue(useInternal);
		};
		this.setSP_Anfrage_RAD_abschliessen = function(value) {
			return this.form.dataMap['SP_Anfrage_RAD_abschliessen'].setValue(value);
		};
		...
		this.getSP_Weiterleiten_an_RAD_Arzt = function(useInternal) {
			return this.form.dataMap['SP_Weiterleiten_an_RAD_Arzt'].getValue(useInternal);
		};
		this.setSP_Weiterleiten_an_RAD_Arzt = function(value) {
			return this.form.dataMap['SP_Weiterleiten_an_RAD_Arzt'].setValue(value);
		};
	}
...
tibcoforms.formCode['_t2USABW8Eemwx6NixRoh7A']['defineValidations']();
