...
tibcoforms.formCode['_jZ96gC98Eem8NYwCvBPJhw'] = new Object();
tibcoforms.formCode['_jZ96gC98Eem8NYwCvBPJhw']['defineActions'] = function() {
var fc = tibcoforms.formCode['_jZ96gC98Eem8NYwCvBPJhw'];
...
tibcoforms.formCode['_jZ96gC98Eem8NYwCvBPJhw']['defineActions']();

tibcoforms.formCode['_jZ96gC98Eem8NYwCvBPJhw']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_jZ96gC98Eem8NYwCvBPJhw'];
...
fc['validation_Mitglied_anmeldenummer_Mitglied_anmeldenummer__length'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getSP_Abschluss_in_WebAI = function(useInternal) {
			return this.form.dataMap['SP_Abschluss_in_WebAI'].getValue(useInternal);
		};
		this.setSP_Abschluss_in_WebAI = function(value) {
			return this.form.dataMap['SP_Abschluss_in_WebAI'].setValue(value);
		};
		this.getSP_Mitteilungskopie_an_Regress = function(useInternal) {
			return this.form.dataMap['SP_Mitteilungskopie_an_Regress'].getValue(useInternal);
		};
		this.setSP_Mitteilungskopie_an_Regress = function(value) {
			return this.form.dataMap['SP_Mitteilungskopie_an_Regress'].setValue(value);
		};
		this.getSP_Taggeld_Meldung_an_AK_LEI = function(useInternal) {
			return this.form.dataMap['SP_Taggeld_Meldung_an_AK_LEI'].getValue(useInternal);
		};
		this.setSP_Taggeld_Meldung_an_AK_LEI = function(value) {
			return this.form.dataMap['SP_Taggeld_Meldung_an_AK_LEI'].setValue(value);
		};
		this.getSP_Verfuegungskopie_an_RB = function(useInternal) {
			return this.form.dataMap['SP_Verfuegungskopie_an_RB'].getValue(useInternal);
		};
		this.setSP_Verfuegungskopie_an_RB = function(value) {
			return this.form.dataMap['SP_Verfuegungskopie_an_RB'].setValue(value);
		};
		this.getSP_Verfuegungskopie_an_ZL = function(useInternal) {
			return this.form.dataMap['SP_Verfuegungskopie_an_ZL'].getValue(useInternal);
		};
		this.setSP_Verfuegungskopie_an_ZL = function(value) {
			return this.form.dataMap['SP_Verfuegungskopie_an_ZL'].setValue(value);
		};
...
tibcoforms.formCode['_jZ96gC98Eem8NYwCvBPJhw']['defineValidations']();
