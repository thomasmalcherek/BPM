...
tibcoforms.formCode['_t6p_cBW8Eemwx6NixRoh7A'] = new Object();
tibcoforms.formCode['_t6p_cBW8Eemwx6NixRoh7A']['defineActions'] = function() {
var fc = tibcoforms.formCode['_t6p_cBW8Eemwx6NixRoh7A'];
...
tibcoforms.formCode['_t6p_cBW8Eemwx6NixRoh7A']['defineActions']();

tibcoforms.formCode['_t6p_cBW8Eemwx6NixRoh7A']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_t6p_cBW8Eemwx6NixRoh7A'];
...
fc['validation_Dokument_dokumentID_Dokument_dokumentID__length'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getSP_Beschluss_fassen = function(useInternal) {
			return this.form.dataMap['SP_Beschluss_fassen'].getValue(useInternal);
		};
		this.setSP_Beschluss_fassen = function(value) {
			return this.form.dataMap['SP_Beschluss_fassen'].setValue(value);
		};
		this.getSP_weitere_Abklaerungen_vornehmen = function(useInternal) {
			return this.form.dataMap['SP_weitere_Abklaerungen_vornehmen'].getValue(useInternal);
		};
		this.setSP_weitere_Abklaerungen_vornehmen = function(value) {
			return this.form.dataMap['SP_weitere_Abklaerungen_vornehmen'].setValue(value);
		};
...
tibcoforms.formCode['_t6p_cBW8Eemwx6NixRoh7A']['defineValidations']();
