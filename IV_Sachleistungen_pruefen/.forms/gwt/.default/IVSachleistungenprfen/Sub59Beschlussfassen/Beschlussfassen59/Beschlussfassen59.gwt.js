...
tibcoforms.formCode['_jwu0sC98Eem8NYwCvBPJhw'] = new Object();
tibcoforms.formCode['_jwu0sC98Eem8NYwCvBPJhw']['defineActions'] = function() {
var fc = tibcoforms.formCode['_jwu0sC98Eem8NYwCvBPJhw'];
...
tibcoforms.formCode['_jwu0sC98Eem8NYwCvBPJhw']['defineActions']();

tibcoforms.formCode['_jwu0sC98Eem8NYwCvBPJhw']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_jwu0sC98Eem8NYwCvBPJhw'];
...
fc['validation_Versicherter_personID_Versicherter_personID__length'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getWP_IV_Textkatalog_oeffnen = function(useInternal) {
			return this.form.dataMap['WP_IV_Textkatalog_oeffnen'].getValue(useInternal);
		};
		this.setWP_IV_Textkatalog_oeffnen = function(value) {
			return this.form.dataMap['WP_IV_Textkatalog_oeffnen'].setValue(value);
		};
		this.getSP_Beschluss_zur_Pruefung = function(useInternal) {
			return this.form.dataMap['SP_Beschluss_zur_Pruefung'].getValue(useInternal);
		};
		this.setSP_Beschluss_zur_Pruefung = function(value) {
			return this.form.dataMap['SP_Beschluss_zur_Pruefung'].setValue(value);
		};
		this.getSP_Beschluss_ohne_Visum = function(useInternal) {
			return this.form.dataMap['SP_Beschluss_ohne_Visum'].getValue(useInternal);
		};
		this.setSP_Beschluss_ohne_Visum = function(value) {
			return this.form.dataMap['SP_Beschluss_ohne_Visum'].setValue(value);
		};
		this.getZurueck_zu_Hauptprozess = function(useInternal) {
			return this.form.dataMap['Zurueck_zu_Hauptprozess'].getValue(useInternal);
		};
		this.setZurueck_zu_Hauptprozess = function(value) {
			return this.form.dataMap['Zurueck_zu_Hauptprozess'].setValue(value);
		};
...
tibcoforms.formCode['_jwu0sC98Eem8NYwCvBPJhw']['defineValidations']();
