...
tibcoforms.formCode['_jUF8AC98Eem8NYwCvBPJhw'] = new Object();
tibcoforms.formCode['_jUF8AC98Eem8NYwCvBPJhw']['defineActions'] = function() {
var fc = tibcoforms.formCode['_jUF8AC98Eem8NYwCvBPJhw'];
...
tibcoforms.formCode['_jUF8AC98Eem8NYwCvBPJhw']['defineActions']();

tibcoforms.formCode['_jUF8AC98Eem8NYwCvBPJhw']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_jUF8AC98Eem8NYwCvBPJhw'];
...
fc['validation_Frist_Vorbescheidverfahren_Frist_Vorbescheidverfahren__datetime'] = function(formId, controlName, cloneUID, listIndex) {
	var valScr = 'typeof context.stringValue != \'undefined\' && typeof tibco.forms.Util != \'undefined\' ? tibco.forms.Util.checkDateTimeFormat(context.stringValue) ?  true : [context.control.getLabel()] : true;';
	// return tibco.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Frist_Vorbescheidverfahren: Frist_Vorbescheidverfahren__datetime", true, true);
	return tibco.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Frist_Vorbescheidverfahren__datetime", true, true);
}
...
fc['validation_Dokument_formularempfnger_Dokument_formularempfnger__length'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getSP_Verfuegung_zum_Visum = function(useInternal) {
			return this.form.dataMap['SP_Verfuegung_zum_Visum'].getValue(useInternal);
		};
		this.setSP_Verfuegung_zum_Visum = function(value) {
			return this.form.dataMap['SP_Verfuegung_zum_Visum'].setValue(value);
		};
		this.getSP_Einwand_zum_Vorbescheid_bearbeiten = function(useInternal) {
			return this.form.dataMap['SP_Einwand_zum_Vorbescheid_bearbeiten'].getValue(useInternal);
		};
		this.setSP_Einwand_zum_Vorbescheid_bearbeiten = function(value) {
			return this.form.dataMap['SP_Einwand_zum_Vorbescheid_bearbeiten'].setValue(value);
		};
		this.getSP_Verfuegung_ohne_Visum = function(useInternal) {
			return this.form.dataMap['SP_Verfuegung_ohne_Visum'].getValue(useInternal);
		};
		this.setSP_Verfuegung_ohne_Visum = function(value) {
			return this.form.dataMap['SP_Verfuegung_ohne_Visum'].setValue(value);
		};
		this.getFrist_Vorbescheidverfahren = function(useInternal) {
			return this.form.dataMap['Frist_Vorbescheidverfahren'].getValue(useInternal);
		};
		this.setFrist_Vorbescheidverfahren = function(value) {
			return this.form.dataMap['Frist_Vorbescheidverfahren'].setValue(value);
		};
...
tibcoforms.formCode['_jUF8AC98Eem8NYwCvBPJhw']['defineValidations']();
