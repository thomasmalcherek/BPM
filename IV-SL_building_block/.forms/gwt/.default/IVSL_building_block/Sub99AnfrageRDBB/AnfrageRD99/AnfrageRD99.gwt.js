...
tibcoforms.formCode['_IpNxoC94Eem8NYwCvBPJhw'] = new Object();
tibcoforms.formCode['_IpNxoC94Eem8NYwCvBPJhw']['defineActions'] = function() {
var fc = tibcoforms.formCode['_IpNxoC94Eem8NYwCvBPJhw'];
...
tibcoforms.formCode['_IpNxoC94Eem8NYwCvBPJhw']['defineActions']();

tibcoforms.formCode['_IpNxoC94Eem8NYwCvBPJhw']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_IpNxoC94Eem8NYwCvBPJhw'];
...
fc['validation_Geschaeftsfall_typBezeichnung_Geschaeftsfall_typBezeichnung__length'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getWP_Auftrage_zum_Gesuch_anzeigen = function(useInternal) {
			return this.form.dataMap['WP_Auftrage_zum_Gesuch_anzeigen'].getValue(useInternal);
		};
		this.setWP_Auftrage_zum_Gesuch_anzeigen = function(value) {
			return this.form.dataMap['WP_Auftrage_zum_Gesuch_anzeigen'].setValue(value);
		};
		...
		this.getMitarbeiter_RD = function(useInternal) {
			return this.form.dataMap['Mitarbeiter_RD'].getValue(useInternal);
		};
		this.setMitarbeiter_RD = function(value) {
			return this.form.dataMap['Mitarbeiter_RD'].setValue(value);
		};
		this.getKernprozessLeitung = function(useInternal) {
			return this.form.dataMap['KernprozessLeitung'].getValue(useInternal);
		};
		this.setKernprozessLeitung = function(value) {
			return this.form.dataMap['KernprozessLeitung'].setValue(value);
		};
		this.getMitarbeiter_AD = function(useInternal) {
			return this.form.dataMap['Mitarbeiter_AD'].getValue(useInternal);
		};
		this.setMitarbeiter_AD = function(value) {
			return this.form.dataMap['Mitarbeiter_AD'].setValue(value);
		};
	}
...
tibcoforms.formCode['_IpNxoC94Eem8NYwCvBPJhw']['defineValidations']();
