...
tibcoforms.formCode['_tduy4BW8Eemwx6NixRoh7A'] = new Object();
tibcoforms.formCode['_tduy4BW8Eemwx6NixRoh7A']['defineActions'] = function() {
var fc = tibcoforms.formCode['_tduy4BW8Eemwx6NixRoh7A'];
...
tibcoforms.formCode['_tduy4BW8Eemwx6NixRoh7A']['defineActions']();

tibcoforms.formCode['_tduy4BW8Eemwx6NixRoh7A']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_tduy4BW8Eemwx6NixRoh7A'];
...
fc['validation_Versicherte_sprache_Versicherte_sprache__length'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getSP_zurueck_zu_SB_IV = function(useInternal) {
			return this.form.dataMap['SP_zurueck_zu_SB_IV'].getValue(useInternal);
		};
		this.setSP_zurueck_zu_SB_IV = function(value) {
			return this.form.dataMap['SP_zurueck_zu_SB_IV'].setValue(value);
		};
...
tibcoforms.formCode['_tduy4BW8Eemwx6NixRoh7A']['defineValidations']();
