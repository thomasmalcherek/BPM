...
tibcoforms.formCode['_tYXKsBW8Eemwx6NixRoh7A'] = new Object();
tibcoforms.formCode['_tYXKsBW8Eemwx6NixRoh7A']['defineActions'] = function() {
var fc = tibcoforms.formCode['_tYXKsBW8Eemwx6NixRoh7A'];
...
tibcoforms.formCode['_tYXKsBW8Eemwx6NixRoh7A']['defineActions']();

tibcoforms.formCode['_tYXKsBW8Eemwx6NixRoh7A']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_tYXKsBW8Eemwx6NixRoh7A'];
...
fc['validation_Dokument_documentScanDate_Dokument_documentScanDate__datetime'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getGesuch_ist_OK = function(useInternal) {
			return this.form.dataMap['Gesuch_ist_OK'].getValue(useInternal);
		};
		this.setGesuch_ist_OK = function(value) {
			return this.form.dataMap['Gesuch_ist_OK'].setValue(value);
		};
		this.getGesuch_ist_nicht_OK = function(useInternal) {
			return this.form.dataMap['Gesuch_ist_nicht_OK'].getValue(useInternal);
		};
		this.setGesuch_ist_nicht_OK = function(value) {
			return this.form.dataMap['Gesuch_ist_nicht_OK'].setValue(value);
		};
...
tibcoforms.formCode['_tYXKsBW8Eemwx6NixRoh7A']['defineValidations']();
