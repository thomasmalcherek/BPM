...
tibcoforms.formCode['_IlcE4C94Eem8NYwCvBPJhw'] = new Object();
tibcoforms.formCode['_IlcE4C94Eem8NYwCvBPJhw']['defineActions'] = function() {
var fc = tibcoforms.formCode['_IlcE4C94Eem8NYwCvBPJhw'];
...
tibcoforms.formCode['_IlcE4C94Eem8NYwCvBPJhw']['defineActions']();

tibcoforms.formCode['_IlcE4C94Eem8NYwCvBPJhw']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_IlcE4C94Eem8NYwCvBPJhw'];
...
fc['validation_Mitglied_foundingDate_Mitglied_foundingDate__datetime'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getBSV_ist_OK = function(useInternal) {
			return this.form.dataMap['BSV_ist_OK'].getValue(useInternal);
		};
		this.setBSV_ist_OK = function(value) {
			return this.form.dataMap['BSV_ist_OK'].setValue(value);
		};
...
tibcoforms.formCode['_IlcE4C94Eem8NYwCvBPJhw']['defineValidations']();
