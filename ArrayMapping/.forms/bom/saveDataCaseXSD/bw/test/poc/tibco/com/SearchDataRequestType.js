 ...
 * This provides an implementation of the class saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataRequestType. 
 */ 


com.tibco.data.Loader.classDefiner["saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataRequestType"] = function() {
...
theClass.LOADER.registerClass(theClass, "saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataRequestType");
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataRequestType");
	return attType;
};
...
theClass.prototype.getDokumentenArt = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataRequestType").ATTR_DOKUMENTENART, useInternal);
};

theClass.prototype.setDokumentenArt = function(dokumentenArt) {
    this._setPrimitiveAttribute(this.loader.getClass("saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataRequestType").ATTR_DOKUMENTENART, dokumentenArt);
};


theClass.prototype.getGeschaeftsfall = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataRequestType").ATTR_GESCHAEFTSFALL, useInternal);
};

theClass.prototype.setGeschaeftsfall = function(geschaeftsfall) {
    this._setPrimitiveAttribute(this.loader.getClass("saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataRequestType").ATTR_GESCHAEFTSFALL, geschaeftsfall);
};
...
com.tibco.data.Loader.classDefiner["saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataRequestType"]();
