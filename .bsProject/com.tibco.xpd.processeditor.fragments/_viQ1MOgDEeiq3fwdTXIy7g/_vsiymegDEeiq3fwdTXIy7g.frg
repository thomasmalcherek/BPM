...
<xpdl2:Package xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:database="http://www.tibco.com/XPD/database1.0.0" xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:iProcessExt="http://www.tibco.com/XPD/iProcessExt1.0.0" xmlns:simulation="http://www.tibco.com/xpd/Simulation1.0.1" xmlns:xpdExt="http://www.tibco.com/XPD/xpdExtension1.0.0" xmlns:xpdl2="http://www.wfmc.org/2008/XPDL2.1" xsi:schemaLocation="http://www.wfmc.org/2008/XPDL2.1 http://www.wfmc.org/standards/bpmnxpdl_31.xsd" Id="_8v5zwIDeEd28P6TQ-F95eg" xpdExt:DisplayName="ProcessPackage" Name="ProcessPackage">
  ...
  <xpdl2:WorkflowProcesses>
    <xpdl2:WorkflowProcess Id="_8v5zwYDeEd28P6TQ-F95eg" xpdExt:FlowRoutingStyle="UncenteredOnTasks" xpdExt:DisplayName="ProcessPackage-Process" Name="ProcessPackageProcess">
      <xpdl2:ProcessHeader>
        <xpdl2:Description></xpdl2:Description>
      </xpdl2:ProcessHeader>
      <xpdl2:DataFields>
      ...
      <xpdl2:Activities>
        <xpdl2:Activity Id="_9RSCloDeEd28P6TQ-F95eg" Name="StartEvent" xpdExt:DisplayName="Start Event">
          <xpdl2:Event>
        ...
        <xpdl2:Activity Id="_9RSCl4DeEd28P6TQ-F95eg" Name="Capturename" FinishMode="Manual" IsATransaction="false" StartMode="Manual" xpdExt:DisplayName="Capture name">
          ...
          <xpdExt:ActivityResourcePatterns>
            <xpdExt:AllocationStrategy xpdExt:Offer="AllocateOne" xpdExt:Strategy="SYSTEM_DETERMINED" xpdExt:ReOfferOnClose="true" xpdExt:ReOfferOnCancel="true"/>
        ...
        <xpdl2:Activity Id="_9RSCmoDeEd28P6TQ-F95eg" Name="EndEvent" xpdExt:DisplayName="End Event">
          <xpdl2:Event>
            <xpdl2:EndEvent/>
          </xpdl2:Event>
          <xpdl2:NodeGraphicsInfos>
        ...
        <xpdl2:Activity Id="_9RSCm4DeEd28P6TQ-F95eg" Name="Displaymessage" xpdExt:DisplayName="Display message">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskUser Implementation="Unspecified">
                <xpdl2:Performers>
        ...
        <xpdl2:Activity Id="_9RSCnoDeEd28P6TQ-F95eg" Name="Createmessage" xpdExt:DisplayName="Create message">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskScript>
