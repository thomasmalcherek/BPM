...
<xpdl2:Package xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:database="http://www.tibco.com/XPD/database1.0.0" xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:iProcessExt="http://www.tibco.com/XPD/iProcessExt1.0.0" xmlns:simulation="http://www.tibco.com/xpd/Simulation1.0.1" xmlns:xpdExt="http://www.tibco.com/XPD/xpdExtension1.0.0" xmlns:xpdl2="http://www.wfmc.org/2008/XPDL2.1" xsi:schemaLocation="http://www.wfmc.org/2008/XPDL2.1 http://www.wfmc.org/standards/bpmnxpdl_31.xsd" Id="_2kmyUIDiEd28P6TQ-F95eg" xpdExt:DisplayName="ProcessPackage" Name="ProcessPackage">
  ...
  <xpdl2:WorkflowProcesses>
    <xpdl2:WorkflowProcess Id="_2kmyUYDiEd28P6TQ-F95eg" xpdExt:FlowRoutingStyle="UncenteredOnTasks" xpdExt:DisplayName="ProcessPackage-Process" Name="ProcessPackageProcess">
      <xpdl2:ProcessHeader>
        <xpdl2:Description></xpdl2:Description>
      </xpdl2:ProcessHeader>
      <xpdl2:ActivitySets>
        <xpdl2:ActivitySet Id="_3tee6IDiEd28P6TQ-F95eg">
          <xpdl2:Activities>
            <xpdl2:Activity Id="_3tee6YDiEd28P6TQ-F95eg" Name="End" xpdExt:DisplayName="End">
              <xpdl2:Event>
            ...
            <xpdl2:Activity Id="_3tee6oDiEd28P6TQ-F95eg" Name="Start" xpdExt:DisplayName="Start">
              <xpdl2:Event>
      ...
      <xpdl2:Activities>
        <xpdl2:Activity Id="_3tee54DiEd28P6TQ-F95eg" Name="EmbeddedSubProcess" xpdExt:DisplayName="Embedded Sub-Process">
          <xpdl2:BlockActivity ActivitySetId="_3tee6IDiEd28P6TQ-F95eg" View="EXPANDED"/>
