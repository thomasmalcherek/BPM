...
import com.example.com.tibco.wf.main.subprocess.bdsutil.BDSTypeConversions;
 ...
 * <ul>
 *   <li>{@link com.example.com.tibco.wf.main.subprocess.impl.MetaDataImpl#getAHVNummer <em>AHV Nummer</em>}</li>
 *   <li>{@link com.example.com.tibco.wf.main.subprocess.impl.MetaDataImpl#getPartnerID <em>Partner ID</em>}</li>
 *   <li>{@link com.example.com.tibco.wf.main.subprocess.impl.MetaDataImpl#getDokumentenArt <em>Dokumenten Art</em>}</li>
 *   <li>{@link com.example.com.tibco.wf.main.subprocess.impl.MetaDataImpl#getKanton <em>Kanton</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MetaDataImpl extends EObjectImpl implements MetaData
{
  ...
  {
    return SubprocessPackage.Literals.META_DATA;
  }
  ...
  public void setAHVNummer(String newAHVNummer)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SubprocessPackage.META_DATA__AHV_NUMMER, oldAHVNummer, ahvNummer));
  }
  ...
  public void setPartnerID(String newPartnerID)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SubprocessPackage.META_DATA__PARTNER_ID, oldPartnerID, partnerID));
  }
  ...
  public void setDokumentenArt(String newDokumentenArt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SubprocessPackage.META_DATA__DOKUMENTEN_ART, oldDokumentenArt, dokumentenArt));
  }
  ...
  public void setKanton(String newKanton)
  {
    ...
    kanton = newKanton;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SubprocessPackage.META_DATA__KANTON, oldKanton, kanton));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SubprocessPackage.META_DATA__AHV_NUMMER:
        return getAHVNummer();
      case SubprocessPackage.META_DATA__PARTNER_ID:
        return getPartnerID();
      case SubprocessPackage.META_DATA__DOKUMENTEN_ART:
        return getDokumentenArt();
      case SubprocessPackage.META_DATA__KANTON:
        return getKanton();
    }
