...
theClass.PRIMITIVE_ATTRIBUTE_NAMES = [theClass.ATTR_AHVNUMMER, theClass.ATTR_DOKUMENTENART, theClass.ATTR_GESCHAEFTSFALL, theClass.ATTR_ANZAHL_DER_DOKUMENTE];

theClass.COMPOSITE_ATTRIBUTE_NAMES = [];

theClass.ATTRIBUTE_NAMES = [theClass.ATTR_AHVNUMMER, theClass.ATTR_DOKUMENTENART, theClass.ATTR_GESCHAEFTSFALL, theClass.ATTR_ANZAHL_DER_DOKUMENTE];
...
theClass.prototype.getGeschaeftsfall = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("saveDataCaseXSD.bw.test.poc.tibco.com.CreateCaseIDRequestType").ATTR_GESCHAEFTSFALL, useInternal);
};

theClass.prototype.setGeschaeftsfall = function(geschaeftsfall) {
    this._setPrimitiveAttribute(this.loader.getClass("saveDataCaseXSD.bw.test.poc.tibco.com.CreateCaseIDRequestType").ATTR_GESCHAEFTSFALL, geschaeftsfall);
};
