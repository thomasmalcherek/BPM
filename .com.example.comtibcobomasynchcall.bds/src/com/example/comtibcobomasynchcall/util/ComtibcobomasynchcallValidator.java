 ...
 * $Id$
 */
package com.example.comtibcobomasynchcall.util;
 ...
 * @generated
 */
public class ComtibcobomasynchcallValidator extends EObjectValidator
{
  /**
   ...
   * @generated
   */
  public static final ComtibcobomasynchcallValidator INSTANCE = new ComtibcobomasynchcallValidator();
   ...
   * @generated
   */
  public static final String DIAGNOSTIC_SOURCE = "com.example.comtibcobomasynchcall";
   ...
   * @generated
   */
  public ComtibcobomasynchcallValidator()
  {
    super();
  ...
  protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    switch (classifierID)
    {
      case ComtibcobomasynchcallPackage.DOCUMENT_ROOT:
        return validateDocumentRoot((DocumentRoot)value, diagnostics, context);
      case ComtibcobomasynchcallPackage.META_DATA:
  ...
  public boolean validateAHVNummer_MetaDataType_MaxLength(String ahvNummer_MetaDataType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    if (!result && diagnostics != null)
      reportMaxLengthViolation(ComtibcobomasynchcallPackage.Literals.AHV_NUMMER_META_DATA_TYPE, ahvNummer_MetaDataType, length, 50, diagnostics, context);
    return result;
  }
  ...
  public boolean validatedokumentenArt_MetaDataType_MaxLength(String dokumentenArt_MetaDataType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    boolean result = length <= 50;
    if (!result && diagnostics != null)
      reportMaxLengthViolation(ComtibcobomasynchcallPackage.Literals.DOKUMENTEN_ART_META_DATA_TYPE, dokumentenArt_MetaDataType, length, 50, diagnostics, context);
    return result;
  }
  ...
  public boolean validatekanton_MetaDataType_MaxLength(String kanton_MetaDataType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    boolean result = length <= 50;
    if (!result && diagnostics != null)
      reportMaxLengthViolation(ComtibcobomasynchcallPackage.Literals.KANTON_META_DATA_TYPE, kanton_MetaDataType, length, 50, diagnostics, context);
    return result;
  }
  ...
  public boolean validatepartnerID_MetaDataType_MaxLength(String partnerID_MetaDataType, DiagnosticChain diagnostics, Map<Object, Object> context)
  {
    ...
    boolean result = length <= 50;
    if (!result && diagnostics != null)
      reportMaxLengthViolation(ComtibcobomasynchcallPackage.Literals.PARTNER_ID_META_DATA_TYPE, partnerID_MetaDataType, length, 50, diagnostics, context);
    return result;
  }
...
} //ComtibcobomasynchcallValidator
