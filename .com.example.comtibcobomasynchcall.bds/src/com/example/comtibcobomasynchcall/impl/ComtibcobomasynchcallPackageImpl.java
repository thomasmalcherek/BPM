...
import com.example.comtibcobomasynchcall.ComtibcobomasynchcallFactory;
...
import com.example.comtibcobomasynchcall.bdsutil.BDSActivator;

import com.example.comtibcobomasynchcall.util.ComtibcobomasynchcallValidator;
 ...
 * @generated
 */
public class ComtibcobomasynchcallPackageImpl extends EPackageImpl implements ComtibcobomasynchcallPackage
{
   ...
   * @see com.example.comtibcobomasynchcall.ComtibcobomasynchcallPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private ComtibcobomasynchcallPackageImpl()
  {
    super(eNS_URI, ComtibcobomasynchcallFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link ComtibcobomasynchcallPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static ComtibcobomasynchcallPackage init()
  {
    if (isInited) return (ComtibcobomasynchcallPackage)EPackage.Registry.INSTANCE.getEPackage(ComtibcobomasynchcallPackage.eNS_URI);

    // Obtain or create and register package
    ComtibcobomasynchcallPackageImpl theComtibcobomasynchcallPackage = (ComtibcobomasynchcallPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ComtibcobomasynchcallPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ComtibcobomasynchcallPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theComtibcobomasynchcallPackage.createPackageContents();

    // Initialize created meta-data
    theComtibcobomasynchcallPackage.initializePackageContents();

    // Register package validator
    EValidator.Registry.INSTANCE.put
      (theComtibcobomasynchcallPackage, 
       new EValidator.Descriptor()
       {
         public EValidator getEValidator()
         {
           return ComtibcobomasynchcallValidator.INSTANCE;
         }
       });

    // Mark meta-data to indicate it can't be changed
    theComtibcobomasynchcallPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(ComtibcobomasynchcallPackage.eNS_URI, theComtibcobomasynchcallPackage);
    return theComtibcobomasynchcallPackage;
  }
   ...
   * @generated
   */
  public ComtibcobomasynchcallFactory getComtibcobomasynchcallFactory()
  {
    return (ComtibcobomasynchcallFactory)getEFactoryInstance();
  }
  ...
  protected void createBdsAnnotations()
  {
    ...
    addAnnotation
      (this, 
       ...
       new String[] 
       {
       "BomFileName", "L/com.tibco.bom.asynchCall/Business Objects/comtibcobomasynchCall.bom",
       "majorVersion", "1",
       "ecoreFormat", "1",
       "label", "com.example.comtibcobomasynchcall"
       });													
    addAnnotation
      (metaDataEClass, 
       source, 
...
} //ComtibcobomasynchcallPackageImpl
