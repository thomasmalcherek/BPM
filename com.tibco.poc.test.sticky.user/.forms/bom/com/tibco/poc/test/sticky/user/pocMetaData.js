 ...
 * This provides an implementation of the class com.tibco.poc.test.sticky.user.pocMetaData. 
 */ 


com.tibco.data.Loader.classDefiner["com.tibco.poc.test.sticky.user.pocMetaData"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.tibco.poc.test.sticky.user.pocMetaData");
...
theClass.getName = function() {
    return "com.tibco.poc.test.sticky.user.pocMetaData";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.tibco.poc.test.sticky.user.pocMetaData");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData");
};

theClass.prototype.getWFCaseID = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_WFCASEID, useInternal);
};

theClass.prototype.setWFCaseID = function(WFCaseID) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_WFCASEID, WFCaseID);
};


theClass.prototype.getAHVNummer = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_AHVNUMMER, useInternal);
};

theClass.prototype.setAHVNummer = function(AHVNummer) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_AHVNUMMER, AHVNummer);
};


theClass.prototype.getPartnerID = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_PARTNERID, useInternal);
};

theClass.prototype.setPartnerID = function(partnerID) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_PARTNERID, partnerID);
};


theClass.prototype.getDokumentenArt = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_DOKUMENTENART, useInternal);
};

theClass.prototype.setDokumentenArt = function(dokumentenArt) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_DOKUMENTENART, dokumentenArt);
};


theClass.prototype.getKanton = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_KANTON, useInternal);
};

theClass.prototype.setKanton = function(kanton) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_KANTON, kanton);
};


theClass.prototype.getFrist = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_FRIST, useInternal);
};

theClass.prototype.setFrist = function(frist) {
    this._setPrimitiveAttribute(this.loader.getClass("com.tibco.poc.test.sticky.user.pocMetaData").ATTR_FRIST, frist);
};
...
com.tibco.data.Loader.classDefiner["com.tibco.poc.test.sticky.user.pocMetaData"]();
