...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Data WF Case ID Response Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.impl.GetDataWFCaseIDResponseTypeImpl#getCaseID <em>Case ID</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.impl.GetDataWFCaseIDResponseTypeImpl#getAHVNummer <em>AHV Nummer</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.impl.GetDataWFCaseIDResponseTypeImpl#getDokumentenArt <em>Dokumenten Art</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.impl.GetDataWFCaseIDResponseTypeImpl#getGeschaeftsfall <em>Geschaeftsfall</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.impl.GetDataWFCaseIDResponseTypeImpl#getAnzahl_der_Dokumente <em>Anzahl der Dokumente</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GetDataWFCaseIDResponseTypeImpl extends EObjectImpl implements GetDataWFCaseIDResponseType
{
  /**
   ...
   * @generated
   */
  protected GetDataWFCaseIDResponseTypeImpl()
  {
    super();
  }
  ...
  {
    return ComPackage.Literals.GET_DATA_WF_CASE_ID_RESPONSE_TYPE;
  }
  ...
  public void setCaseID(String newCaseID)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComPackage.GET_DATA_WF_CASE_ID_RESPONSE_TYPE__CASE_ID, oldCaseID, caseID));
  }
  ...
  public void setAHVNummer(String newAHVNummer)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComPackage.GET_DATA_WF_CASE_ID_RESPONSE_TYPE__AHV_NUMMER, oldAHVNummer, ahvNummer));
  }
  ...
  public void setDokumentenArt(String newDokumentenArt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComPackage.GET_DATA_WF_CASE_ID_RESPONSE_TYPE__DOKUMENTEN_ART, oldDokumentenArt, dokumentenArt));
  }
  ...
  public void setGeschaeftsfall(String newGeschaeftsfall)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComPackage.GET_DATA_WF_CASE_ID_RESPONSE_TYPE__GESCHAEFTSFALL, oldGeschaeftsfall, geschaeftsfall));
  }
  ...
  public void setAnzahl_der_Dokumente(BigInteger newAnzahl_der_Dokumente)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComPackage.GET_DATA_WF_CASE_ID_RESPONSE_TYPE__ANZAHL_DER_DOKUMENTE, oldAnzahl_der_Dokumente, anzahl_der_Dokumente));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ComPackage.GET_DATA_WF_CASE_ID_RESPONSE_TYPE__CASE_ID:
        return getCaseID();
      case ComPackage.GET_DATA_WF_CASE_ID_RESPONSE_TYPE__AHV_NUMMER:
        return getAHVNummer();
      case ComPackage.GET_DATA_WF_CASE_ID_RESPONSE_TYPE__DOKUMENTEN_ART:
        return getDokumentenArt();
      case ComPackage.GET_DATA_WF_CASE_ID_RESPONSE_TYPE__GESCHAEFTSFALL:
        return getGeschaeftsfall();
      case ComPackage.GET_DATA_WF_CASE_ID_RESPONSE_TYPE__ANZAHL_DER_DOKUMENTE:
...
} //GetDataWFCaseIDResponseTypeImpl
