...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Search Data Response Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.impl.SearchDataResponseTypeImpl#getCaseID <em>Case ID</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.impl.SearchDataResponseTypeImpl#getAHVNummer <em>AHV Nummer</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.impl.SearchDataResponseTypeImpl#getDokumentenArt <em>Dokumenten Art</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.impl.SearchDataResponseTypeImpl#getGeschaeftsfall <em>Geschaeftsfall</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.impl.SearchDataResponseTypeImpl#getAnzahl_der_Dokumente <em>Anzahl der Dokumente</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SearchDataResponseTypeImpl extends EObjectImpl implements SearchDataResponseType
{
  /**
   ...
   * @generated
   */
  protected SearchDataResponseTypeImpl()
  {
    super();
  }
  ...
  {
    return ComPackage.Literals.SEARCH_DATA_RESPONSE_TYPE;
  }
  ...
  public void setCaseID(String newCaseID)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComPackage.SEARCH_DATA_RESPONSE_TYPE__CASE_ID, oldCaseID, caseID));
  }
  ...
  public void setAHVNummer(String newAHVNummer)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComPackage.SEARCH_DATA_RESPONSE_TYPE__AHV_NUMMER, oldAHVNummer, ahvNummer));
  }
  ...
  public void setDokumentenArt(String newDokumentenArt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComPackage.SEARCH_DATA_RESPONSE_TYPE__DOKUMENTEN_ART, oldDokumentenArt, dokumentenArt));
  }
  ...
  public void setGeschaeftsfall(String newGeschaeftsfall)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComPackage.SEARCH_DATA_RESPONSE_TYPE__GESCHAEFTSFALL, oldGeschaeftsfall, geschaeftsfall));
  }
  ...
  public void setAnzahl_der_Dokumente(BigInteger newAnzahl_der_Dokumente)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComPackage.SEARCH_DATA_RESPONSE_TYPE__ANZAHL_DER_DOKUMENTE, oldAnzahl_der_Dokumente, anzahl_der_Dokumente));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ComPackage.SEARCH_DATA_RESPONSE_TYPE__CASE_ID:
        return getCaseID();
      case ComPackage.SEARCH_DATA_RESPONSE_TYPE__AHV_NUMMER:
        return getAHVNummer();
      case ComPackage.SEARCH_DATA_RESPONSE_TYPE__DOKUMENTEN_ART:
        return getDokumentenArt();
      case ComPackage.SEARCH_DATA_RESPONSE_TYPE__GESCHAEFTSFALL:
        return getGeschaeftsfall();
      case ComPackage.SEARCH_DATA_RESPONSE_TYPE__ANZAHL_DER_DOKUMENTE:
