...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Get Data WF Case ID Response Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.GetDataWFCaseIDResponseType#getCaseID <em>Case ID</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.GetDataWFCaseIDResponseType#getAHVNummer <em>AHV Nummer</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.GetDataWFCaseIDResponseType#getDokumentenArt <em>Dokumenten Art</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.GetDataWFCaseIDResponseType#getGeschaeftsfall <em>Geschaeftsfall</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.GetDataWFCaseIDResponseType#getAnzahl_der_Dokumente <em>Anzahl der Dokumente</em>}</li>
 * </ul>
 * </p>
 *
 * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getGetDataWFCaseIDResponseType()
 * @model extendedMetaData="name='GetDataWFCaseIDResponse_._type' kind='elementOnly'"
 * @generated
 */
@SuppressWarnings("all")
public interface GetDataWFCaseIDResponseType extends EObject
{
  /**
   ...
   * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getGetDataWFCaseIDResponseType_CaseID()
  ...
  /**
   * Sets the value of the '{@link saveDataCaseXSD.bw.test.poc.tibco.com.GetDataWFCaseIDResponseType#getCaseID <em>Case ID</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getGetDataWFCaseIDResponseType_AHVNummer()
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
  ...
  /**
   * Sets the value of the '{@link saveDataCaseXSD.bw.test.poc.tibco.com.GetDataWFCaseIDResponseType#getAHVNummer <em>AHV Nummer</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getGetDataWFCaseIDResponseType_DokumentenArt()
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
  ...
  /**
   * Sets the value of the '{@link saveDataCaseXSD.bw.test.poc.tibco.com.GetDataWFCaseIDResponseType#getDokumentenArt <em>Dokumenten Art</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getGetDataWFCaseIDResponseType_Geschaeftsfall()
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
  ...
  /**
   * Sets the value of the '{@link saveDataCaseXSD.bw.test.poc.tibco.com.GetDataWFCaseIDResponseType#getGeschaeftsfall <em>Geschaeftsfall</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getGetDataWFCaseIDResponseType_Anzahl_der_Dokumente()
  ...
  /**
   * Sets the value of the '{@link saveDataCaseXSD.bw.test.poc.tibco.com.GetDataWFCaseIDResponseType#getAnzahl_der_Dokumente <em>Anzahl der Dokumente</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
