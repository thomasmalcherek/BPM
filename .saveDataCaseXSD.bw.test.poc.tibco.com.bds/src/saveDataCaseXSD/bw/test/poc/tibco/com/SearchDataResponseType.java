...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Search Data Response Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataResponseType#getCaseID <em>Case ID</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataResponseType#getAHVNummer <em>AHV Nummer</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataResponseType#getDokumentenArt <em>Dokumenten Art</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataResponseType#getGeschaeftsfall <em>Geschaeftsfall</em>}</li>
 *   <li>{@link saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataResponseType#getAnzahl_der_Dokumente <em>Anzahl der Dokumente</em>}</li>
 * </ul>
 * </p>
 *
 * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getSearchDataResponseType()
 * @model extendedMetaData="name='SearchDataResponse_._type' kind='elementOnly'"
 * @generated
 */
@SuppressWarnings("all")
public interface SearchDataResponseType extends EObject
{
  /**
   ...
   * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getSearchDataResponseType_CaseID()
  ...
  /**
   * Sets the value of the '{@link saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataResponseType#getCaseID <em>Case ID</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getSearchDataResponseType_AHVNummer()
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
  ...
  /**
   * Sets the value of the '{@link saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataResponseType#getAHVNummer <em>AHV Nummer</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getSearchDataResponseType_DokumentenArt()
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
  ...
  /**
   * Sets the value of the '{@link saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataResponseType#getDokumentenArt <em>Dokumenten Art</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getSearchDataResponseType_Geschaeftsfall()
   * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
  ...
  /**
   * Sets the value of the '{@link saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataResponseType#getGeschaeftsfall <em>Geschaeftsfall</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see saveDataCaseXSD.bw.test.poc.tibco.com.ComPackage#getSearchDataResponseType_Anzahl_der_Dokumente()
  ...
  /**
   * Sets the value of the '{@link saveDataCaseXSD.bw.test.poc.tibco.com.SearchDataResponseType#getAnzahl_der_Dokumente <em>Anzahl der Dokumente</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
